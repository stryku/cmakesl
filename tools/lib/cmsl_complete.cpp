...
cmsl_complete_results* cmsl_complete_at(
  const cmsl_parsed_source* parsed_source, unsigned absolute_position)
{
  return cmsl::tools::completer{ *parsed_source, absolute_position }
    .complete();
}
