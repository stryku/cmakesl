...
namespace cmsl::ast
{
    ...
    const type_representation& user_function_node::return_type_representation() const
    {
    ...
    const user_function_node::params_t& user_function_node::param_declarations() const
    {
        return m_params;
    }
