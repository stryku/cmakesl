...
namespace cmsl::sema
{
                                           ...
                                           const expression_node &initialization_expression) const
    {
        ...
        {
            return check_initialization_of_reference_type(variable_type, initialization_expression);
        }
        else
        {
    ...
    variable_initialization_checker::check_result
    variable_initialization_checker::check_initialization_of_reference_type(const sema_type &variable_type, const expression_node &initialization_expression) const
    {
        const auto& expression_type = initialization_expression.type();
        ...
        return check_initialization(variable_referenced_type, initialization_expression);
    }

    variable_initialization_checker::check_result
    variable_initialization_checker::check_initialization(const sema_type &variable_type, const expression_node &initialization_expression) const
    {
        const auto& expression_type = initialization_expression.type();
