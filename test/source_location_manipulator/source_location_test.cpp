    ...
    namespace test
    {
        namespace source_location
        {
            ...
            namespace inc
            {
                ...
                struct Increments : public IncrementFixture<IncrementsAndExpectedLocationTestState>
                {};
                ...
                const auto values = Values(
                    IncrementsAndExpectedLocationTestState{ "01234", 1u, 1u, 2u, 1u },
                    IncrementsAndExpectedLocationTestState{ "01234", 2u, 1u, 3u, 2u },
                    IncrementsAndExpectedLocationTestState{ "01234", 10u, 1u, 6u, 5u }, // Increment more than chars in source
            ...
            namespace is_at_end
            {
                namespace should_not_reach_end
                {
                    ...
                    INSTANTIATE_TEST_CASE_P(SourceLocationManipulator, LessIncrementsThanSourceSize, values);
                }
                ...
                namespace should_reach_end
                {
                    ...
                    INSTANTIATE_TEST_CASE_P(SourceLocationManipulator, SourceSizeOrMoreIncrements, values);
                }
            }
            ...
            namespace has_next
            {
                ...
                INSTANTIATE_TEST_CASE_P(SourceLocationManipulator, LessThanSourceSizeMinusOneIncrements, values);
            }
