    ...
    namespace sema
    {
        namespace test
        {
            ...
            public:
                ...
                MOCK_CONST_METHOD1(find_type, const sema_type*(const ast::type_representation& name));
                MOCK_CONST_METHOD1(find_referenced_type, const sema_type*(const ast::type_representation& name));
                MOCK_CONST_METHOD1(find_type_in_this_scope, const sema_type*(const ast::type_representation& name));
