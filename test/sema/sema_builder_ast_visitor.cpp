...
namespace cmsl::sema::test
{
    ...
    const auto tmp_token = token_identifier("");
            ...
            TEST_F(SemaBuilderAstVisitorTest, Visit_MemberFunctionCallWithoutParameters_GetMemberFunctionCallNodeWithoutParameters)
            {
                ...
                const sema_type lhs_type{ ctx,  ast::type_representation{ lhs_id_token }, {} };
            ...
            TEST_F(SemaBuilderAstVisitorTest, Visit_ClassWithMembers_GetClassNodeWithMembers)
            {
                ...
                const auto member_type_name_ref = ast::type_representation{ member_type_token };
            ...
            TEST_F(SemaBuilderAstVisitorTest, Visit_ClassMemberAccess_GetClassMemberAccessNode)
            {
                ...
                sema_type lhs_type{ ctx, ast::type_representation{ lhs_type_name_token }, std::move(members)};

                ast::class_member_access_node node{ std::move(lhs_node), tmp_token,  member_name_token };
